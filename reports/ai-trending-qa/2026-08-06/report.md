# GitHub 今日 AI Trending 测开分析（2026-08-06）
...
- Stars：31754
- 主要语言：Go
- Topics：agent, agent-framework, ai-agent, ai-coding, cli, coding-agent, deepseek, developer-tools, ink, llm, prompt-caching, r1
- 项目特色（基于 description/README 片段的轻量提炼）：
